...
public class RunnerSave04 {
    ...
    public static void main(String[] args) {
        ...
        diary1.setStudent(student1); // !!! iliskinin duzgun kurulabilmesi icin diary tarafinda student setlenmesi gerekiyor
        //student1.setDiary(diary1);

        Diary04 diary2 = new Diary04();
        diary2.setId(102);
        diary2.setName("Sinan Beyin Gunlugu");
        diary2.setStudent(student2); // !!! iliskinin duzgun kurulabilmesi icin diary tarafinda student setlenmesi gerekiyor
